...
"""
# https://gitee.com/shede333/SWConvertVideoToAudio/blob/master/convert.py
...
def main():
    ...
    if os.path.isfile(file_path):  # 文件
        ...
        success_num, fail_num = convert_dir(file_path, output_dir,is_traverse=command_param.traverse)
    else:
